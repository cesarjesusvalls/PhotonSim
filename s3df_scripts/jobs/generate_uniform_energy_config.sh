...
echo ""
echo "=== PhotonSim Only (ROOT output) ==="
echo "To prepare jobs:"
echo "  ./submit_photonsim_batch_uniform.sh -c ${CONFIG_FILE}"
echo "To prepare and submit jobs:"
echo "  ./submit_photonsim_batch_uniform.sh -c ${CONFIG_FILE} -s"
echo ""
echo "=== PhotonSim + LUCiD Pipeline (ROOT + HDF5 output) ==="
echo "To prepare jobs:"
echo "  ./submit_photonsim_lucid_batch_uniform.sh -c ${CONFIG_FILE}"
echo "To prepare and submit jobs:"
echo "  ./submit_photonsim_lucid_batch_uniform.sh -c ${CONFIG_FILE} -s"
